...
function App() {
  ...
  return (
    <div className=' w-full h-full overflow-hidden flex justify-center items-center flex-col gap-9'>
      ...
      <button className=' w-[180px] h-[40px] text-black flex bg-green-500 justify-center items-center gap-4 border-none rounded-full cursor-pointer font-bold text-[20px]'>Click here <CiMicrophoneOn className=' h-[30px] w-[30px] ' /></button>
    </div>
  )
}
